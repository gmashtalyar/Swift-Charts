...
struct Book: Identifiable, Equatable {
    ...
    static var examples = [
        ...
        Book(id: UUID(), title: "1984", author: Author.examples[3], category: .fiction, price: 14.99, inventoryCount: 70),
        ...
        Book(id: UUID(), title: "The Very Hungry Catepillar", author: Author.examples[5], category: .children, price: 10.99, inventoryCount: 90),
        ...
        Book(id: UUID(), title: "The Innovator's Dilema", author: Author.examples[1], category: .business, price: 15.99, inventoryCount: 45),
